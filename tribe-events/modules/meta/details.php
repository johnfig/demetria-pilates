	...
	<div class="cmsms_event_meta_info">
		...
		?>
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e( 'Start:', 'the-events-calendar' ) ?></span>
			...
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e( 'End:', 'the-events-calendar' ) ?></span>
				<span class="cmsms_event_meta_info_item_descr">
		...
		elseif ( tribe_event_is_all_day() ):
			?>
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e( 'Date:', 'the-events-calendar' ) ?></span>
				<span class="cmsms_event_meta_info_item_descr">
					<abbr class="tribe-events-abbr updated published dtstart" title="<?php echo esc_attr( $start_ts ); ?>"><?php echo esc_html( $start_date ); ?></abbr>
				</span>
			</div>
		...
		// Single day events
			...
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e( 'Time:', 'the-events-calendar' ) ?></span>
				<span class="cmsms_event_meta_info_item_descr">
		...
		if ( ! empty( $cost ) ) : ?>
			<div class="cmsms_event_meta_info_item">
				<span class="cmsms_event_meta_info_item_title"><?php esc_html_e( 'Cost:', 'the-events-calendar' ) ?></span>
