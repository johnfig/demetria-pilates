...
if (!function_exists('get_custom_campaign_meta_fields')) {
function get_custom_campaign_meta_fields() {
	...
	$tabs_array['cmsms_campaign'] = array( 
		'label' => esc_html__('Campaign', 'yoga-fit'), 
	...
	$custom_campaign_meta_fields = array( 
		...
		array( 
			'label'	=> __('Campaign Target', 'yoga-fit'), 
		...
		array( 
			'label'	=> __('Campaign Title', 'yoga-fit'), 
		...
		array( 
			'label'	=> __('More Campaigns Box', 'yoga-fit'), 
			'desc'	=> '', 
