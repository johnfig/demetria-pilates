...
(function ($) { 
	$(document).ready(function () { 
		...
		if ($('input[name="cmsms_heading"]:checked').val() === 'custom') {
			...
			$('#cmsms_heading_standard_title').closest('tr').hide();
			...
			$('#cmsms_heading_height').closest('tr').show();
			$('#cmsms_heading_standard_title').closest('tr').show();
		} else if ($('input[name="cmsms_heading"]:checked').val() === 'disabled') {
			$('#cmsms_heading_standard_title').closest('tr').hide();
		...
		if ($('#cmsms_tt_event_hours').is(':checked')) {
			$('#cmsms_tt_event_hours_title').closest('tr').show();
		} else {
			$('#cmsms_tt_event_hours_title').closest('tr').hide();
		}
		
		/* Timetable Hours Field Change */
		$('#cmsms_tt_event_hours').bind('change', function () { 
			if ($(this).is(':checked')) {
				$('#cmsms_tt_event_hours_title').closest('tr').show();
			} else {
				$('#cmsms_tt_event_hours_title').closest('tr').hide();
