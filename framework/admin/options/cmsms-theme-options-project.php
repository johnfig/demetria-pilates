...
function get_custom_project_meta_fields() {
	...
	$cmsms_global_portfolio_project_details_title = (isset($cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title']) && $cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title'] !== '') ? $cmsms_option[CMSMS_SHORTNAME . '_portfolio_project_details_title'] : '';
	...
	$tabs_array['cmsms_project'] = array( 
		'label' => esc_html__('Project', 'yoga-fit'), 
		'value'	=> 'cmsms_project' 
	);
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> __('Project Images', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Number of Columns', 'yoga-fit'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => __('Three', 'yoga-fit'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => __('Two', 'yoga-fit'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => __('One', 'yoga-fit'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> __('Project Title', 'yoga-fit'), 
		...
		array( 
			'label'	=> __('Project Size', 'yoga-fit'), 
			'desc'	=> __('Recomended Featured Image dimensions', 'yoga-fit') . ' - ', 
		...
		array( 
			'label'	=> __('Project Details Title', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Info', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __("Project Link Text", 'yoga-fit'), 
			'desc'	=> '', 
			'id'	=> $cmsms_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> __('View Project', 'yoga-fit') 
		), 
		array( 
			'label'	=> __("Project Link URL", 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> __('Redirect to project link URL instead of opening project page', 'yoga-fit'), 
		...
		array( 
			'label'	=> __("Project Link Target", 'yoga-fit'), 
			'desc'	=> __('Open link in a new tab', 'yoga-fit'), 
		...
		array( 
			'label'	=> __('Project Features 1 Title', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 1', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 2 Title', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 2', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 3 Title', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> __('Project Features 3', 'yoga-fit'), 
			'desc'	=> '', 
		...
		array( 
			...
			'options' => array( 
				'related' => array( 
					'label' => __('Show Related Tab', 'yoga-fit'),
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => __('Show Popular Tab', 'yoga-fit'),
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => __('Show Recent Tab', 'yoga-fit'),
					'value'	=> 'recent' 
				) 
			) 
		), 
