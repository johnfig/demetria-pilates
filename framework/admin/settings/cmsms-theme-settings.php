...
function cmsms_get_settings() {
	...
	case CMSMS_PAGE_BASENAME:
		...
		$cmsms_settings_page_title = esc_html__('Theme General Settings', 'yoga-fit');
	...
	case CMSMS_PAGE_BASENAME . '-style':
		...
		$cmsms_settings_page_title = esc_html__('Theme Appearance', 'yoga-fit');
	...
	case CMSMS_PAGE_BASENAME . '-font':
		...
		$cmsms_settings_page_title = esc_html__('Theme Fonts Settings', 'yoga-fit');
	...
	case CMSMS_PAGE_BASENAME . '-color':
		...
		$cmsms_settings_page_title = esc_html__('Theme Color Schemes', 'yoga-fit');
	...
	case CMSMS_PAGE_BASENAME . '-single':
		...
		$cmsms_settings_page_title = esc_html__('Theme Single Posts Settings', 'yoga-fit');
		...
		case 'campaign':
			...
			break;
		case 'tt_event':
			$cmsms_option_name = $cmsms_option_name . '_tt_event';
	...
	case CMSMS_PAGE_BASENAME . '-demo':
		...
		$cmsms_settings_page_title = esc_html__('Theme Settings Import/Export', 'yoga-fit');
...
function cmsms_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		__('Default Field', 'yoga-fit'), 
		'desc' => 		__('This is a default description.', 'yoga-fit'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function cmsms_settings_scripts() {
	...
	wp_localize_script('cmsms_theme_settings_js', 'cmsms_setting', array( 
		...
		'remove_sidebar' => 	esc_html__('Do you realy want to remove this sidebar?', 'yoga-fit'), 
		'find' => 				esc_attr__('Find icons', 'yoga-fit'), 
		'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'yoga-fit'), 
		'theme_uri' => 			get_template_directory_uri(), 
		'shortname' => 			CMSMS_SHORTNAME, 
		'done' => 				esc_html__('All theme settings were imported successfully.', 'yoga-fit'), 
		'fail' => 				esc_html__("Error on page!!!\nPlease reload page and try again.", 'yoga-fit'), 
...
function cmsms_add_menu() {
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'yoga-fit'), 
		esc_attr__('Theme Settings', 'yoga-fit'), 
		'manage_options', 
		CMSMS_PAGE_BASENAME, 
	...
	$cmsms_settings_general = $add_submenu_p( 
		CMSMS_PAGE_BASENAME, 
		esc_attr__('Theme General Settings', 'yoga-fit'), 
		esc_attr__('General', 'yoga-fit'), 
		'manage_options', 
		CMSMS_PAGE_BASENAME, 
		'cmsms_settings_page_fn' 
	);
	...
	$cmsms_settings_style = $add_submenu_p( 
		CMSMS_PAGE_BASENAME, 
		esc_attr__('Theme Appearance', 'yoga-fit'), 
		esc_attr__('Appearance', 'yoga-fit'), 
		'manage_options', 
	...
	$cmsms_settings_font = $add_submenu_p( 
		CMSMS_PAGE_BASENAME, 
		esc_attr__('Theme Fonts Settings', 'yoga-fit'), 
		esc_attr__('Fonts', 'yoga-fit'), 
		'manage_options', 
	...
	$cmsms_settings_color = $add_submenu_p( 
		CMSMS_PAGE_BASENAME, 
		esc_attr__('Theme Color Schemes', 'yoga-fit'), 
		esc_attr__('Colors', 'yoga-fit'), 
		'manage_options', 
	...
	$cmsms_settings_single = $add_submenu_p( 
		CMSMS_PAGE_BASENAME, 
		esc_attr__('Theme Single Posts Settings', 'yoga-fit'), 
		esc_attr__('Single Posts', 'yoga-fit'), 
		'manage_options', 
	...
	$cmsms_settings_demo = $add_submenu_p( 
		CMSMS_PAGE_BASENAME, 
		esc_attr__('Theme Settings Import/Export', 'yoga-fit'), 
		esc_attr__('Import/Export', 'yoga-fit'), 
		'manage_options', 
...
function cmsms_settings_page_fn() {
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'yoga-fit') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'yoga-fit') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsms-demo-import" value="' . esc_attr__('Import Settings', 'yoga-fit') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsms_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'yoga-fit') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsms_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'yoga-fit') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsms_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'yoga-fit') . ' <em>(' . __('in pixels', 'yoga-fit') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsms_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'yoga-fit') . ' <em>(' . __('in pixels', 'yoga-fit') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsms_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'yoga-fit') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsms_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'yoga-fit') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsms_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'yoga-fit') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsms_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'yoga-fit') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'yoga-fit') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsms_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'yoga-fit') . '" />' . 
				'<a href="#" class="cmsms_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'yoga-fit') . '"></a>' . 
			'</p>' . 
			...
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_link">' . 
					...
					__('Icon Link', 'yoga-fit') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					__('Icon Title', 'yoga-fit') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					__('Open link in a new tab/window?', 'yoga-fit') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'yoga-fit') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'yoga-fit') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'yoga-fit') . '"></a> ' . 
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : __('Expecting a Numeric value!', 'yoga-fit');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						CMSMS_SHORTNAME . '_txt_numeric_error',
						__('Expecting a Numeric value! Please fix.', 'yoga-fit'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : __('Expecting comma separated numeric values', 'yoga-fit');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						...
						__('Expecting comma separated numeric values! Please fix.','yoga-fit'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : __('Invalid email! Please re-enter!', 'yoga-fit');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = __('This setting field cannot be empty! Please enter a valid email address.', 'yoga-fit');
				}
				...
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						...
						__('Please enter a valid email address.', 'yoga-fit'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : __('Number!', 'yoga-fit');
...
function theme_admin_bar_render() {
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Theme Settings', 'yoga-fit'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('General', 'yoga-fit'), 
		'href' => esc_url(admin_url('admin.php?page=cmsms-settings')) 
	));
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Appearance', 'yoga-fit'), 
		'href' => esc_url(admin_url('admin.php?page=cmsms-settings-style')) 
	));
	
	$wp_admin_bar->add_menu(array( 
		'parent' => CMSMS_SHORTNAME . '_options', 
		'id' => CMSMS_SHORTNAME . '_theme_settings_font', 
		'title' => esc_attr__('Fonts', 'yoga-fit'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Colors', 'yoga-fit'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Single', 'yoga-fit'), 
...
function cmsms_add_global_options() {
	$cmsms_option_names = array( 
		...
		array( 
			'cmsms_options_' . CMSMS_SHORTNAME . '_single_tt_event', 
			cmsms_options_single_fields('tt_event') 
		) 
	);
