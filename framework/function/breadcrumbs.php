...
function breadcrumbs() {
	...
	$homeText = esc_attr__('Home', 'yoga-fit');
	...
	echo '<span>' . esc_html__('You are here: ', 'yoga-fit') . '</span>' . "\n\t\t" . 
	'<a href="' . esc_url($homeLink) . '" class="cms_home">' . esc_html($homeText) . '</a>' . $sep;
	...
	if (is_single()) {
		...
		echo '<span>' . esc_html__('Search Results for', 'yoga-fit') . ": '" . esc_html(get_search_query()) . "'</span>";
		...
		if (is_tax('post_format', 'post-format-gallery')) {
			echo '<span>' . esc_html_x('Galleries', 'post format archive title', 'yoga-fit') . '</span>';
		} elseif (is_tax('post_format', 'post-format-image')) {
			echo '<span>' . esc_html_x('Images', 'post format archive title', 'yoga-fit') . '</span>';
		} elseif (is_tax('post_format', 'post-format-video')) {
			echo '<span>' . esc_html_x('Videos', 'post format archive title', 'yoga-fit') . '</span>';
		} elseif (is_tax('post_format', 'post-format-audio')) {
			echo '<span>' . esc_html_x('Audio', 'post format archive title', 'yoga-fit') . '</span>';
		}
		...
		echo '<span>' . esc_html__('No breadcrumbs', 'yoga-fit') . '</span>';
	}
}
