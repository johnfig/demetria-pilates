...
function register_js_scripts() {
	if (!is_admin()) {
		...
		if ( 
			...
			wp_enqueue_script('gMapAPI', '//maps.googleapis.com/maps/api/js?key=' . $cmsms_option[CMSMS_SHORTNAME . '_gmap_api_key'], array('jquery'), '1.0.0', true);
...
/* Developer Mode */
function cmsms_developer_mode() {
	if (!is_admin() && CMSMS_DEVELOPER_MODE) {
		...
		if (CMSMS_WOOCOMMERCE) {
			wp_dequeue_style('theme-cmsms-woo-style');
			
			wp_dequeue_style('theme-cmsms-woo-adaptive');
			
			echo '<link rel="stylesheet/less" href="' . get_template_directory_uri() . '/css/less/cmsms-woo-style.less" type="text/css" media="screen" />';
			
			echo '<link rel="stylesheet/less" href="' . get_template_directory_uri() . '/css/less/cmsms-woo-adaptive.less" type="text/css" media="screen" />';
		}
		
		
		if (CMSMS_EVENTS_CALENDAR) {
			wp_dequeue_style('theme-cmsms-events-style');
			
			wp_dequeue_style('theme-cmsms-events-adaptive');
			
			echo '<link rel="stylesheet/less" href="' . get_template_directory_uri() . '/css/less/cmsms-events-style.less" type="text/css" media="screen" />';
			
			echo '<link rel="stylesheet/less" href="' . get_template_directory_uri() . '/css/less/cmsms-events-adaptive.less" type="text/css" media="screen" />';
		}
		
		
		if (CMSMS_TIMETABLE) {
			wp_dequeue_style('theme-cmsms-timetable-style');
			
			wp_dequeue_style('theme-cmsms-timetable-adaptive');
			
			echo '<link rel="stylesheet/less" href="' . get_template_directory_uri() . '/css/less/cmsms-timetable-style.less" type="text/css" media="screen" />';
			
			echo '<link rel="stylesheet/less" href="' . get_template_directory_uri() . '/css/less/cmsms-timetable-adaptive.less" type="text/css" media="screen" />';
		}
...
add_action('wp_enqueue_scripts', 'cmsms_developer_mode');
...
function cmsms_theme_page_layout_scheme() {
	...
	} elseif (CMSMS_EVENTS_CALENDAR && tribe_is_event_query() && isset($cmsms_option[CMSMS_SHORTNAME . '_events_layout'])) {
...
function cmsms_ajax_export_settings_callback() {
	...
	if (wp_verify_nonce($nonce, 'cmsms_ajax_export_settings-nonce')) {
		$options = array( 
			...
			'cmsms_options_' . CMSMS_SHORTNAME . '_color_bottom', 
