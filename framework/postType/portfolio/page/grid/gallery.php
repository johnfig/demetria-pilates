...
<article id="post-<?php the_ID(); ?>" <?php post_class(); echo (($project_categs != '') ? ' data-category="' . esc_attr($project_categs) . '"' : '') ?>>
	...
	<?php 
		cmsms_thumb_rollover(get_the_ID(), $project_thumb_size, false, true, true, $cmsms_project_images, false, false, false, $project_thumb_high, true, $cmsms_project_link_redirect, $cmsms_project_link_url, $rollover);
