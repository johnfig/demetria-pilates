...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php
		if (!post_password_required()) {
			cmsms_thumb_rollover(get_the_ID(), 'blog-masonry-thumb', false, true, true, false, $cmsms_post_video_type, $cmsms_post_video_link, $cmsms_post_video_links, false, true, false, false, $more);
		}
