...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<?php 
		cmsms_thumb_rollover(get_the_ID(), 'project-thumb', false, true, true, $cmsms_project_images, false, false, false, false, true, $cmsms_project_link_redirect, $cmsms_project_link_url, $more);
